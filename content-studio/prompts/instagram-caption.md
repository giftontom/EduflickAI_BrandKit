...
- Apply link:            [[link in bio only — do NOT print a URL on IG]]
...
- Goal / CTA intent: [[e.g. apply (link in bio) | book a seat | save+follow]]
...
3. Exactly ONE CTA, matched to the funnel phase. On Instagram: NO website URL — CTA is
   "apply — link in bio". Never print eduflickai.com/apply or any URL in IG captions.
...
> **CTA:** book your seat — only [[__]] of 20 left. apply — link in bio
