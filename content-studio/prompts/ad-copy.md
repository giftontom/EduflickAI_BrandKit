...
Load `00_SYSTEM_PROMPT.md` first. Paid splits into two jobs: **lead-gen** (cold → free masterclass)
...
3. CTA button: lead-gen → "Sign Up" / "Learn More" (copy says "register free →"); retargeting →
