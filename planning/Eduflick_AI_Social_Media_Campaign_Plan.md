...
| **Funnel goal** | Drive registrations to the **Apply page** (top of funnel → seat bookings) |
...
- B.Tech graduates (2024–2026) who can code but feel "AI-left-behind"
- Junior software professionals (0–2 yrs) in/around Trivandrum wanting an AI skill jump
- Parents/decision-influencers (secondary, for the ₹49K investment conversation)

**Their pain (use their words in copy):**
...
2. **Lead capture** — Everything points to the **Apply page** (live, ~90 min, builds a tiny AI app on the spot).
...
- **Run a live build demo** (mid-Phase 2). Record it → clip for Phase 3.
...
- **Sold-out announcement** (becomes Cohort 2 waitlist bait).
...
## 7. Paid Ads Plan (Meta / Instagram)
...
Pull all creative from the Eduflick Brand Book (`Eduflick_Brand_Book_v4.html`) and logo set (`assets/logo/`).

| Element | Spec |
|---|---|
| **Primary** | Indigo `#5B5BF0` |
| **Paper / background** | Cream `#F5F2EA` |
| **Ink / text** | `#0A0B10` |
| **Accent** | Coral `#FF6E5A` (use sparingly — CTAs, scarcity flags) |
| **Headline font** | Manrope 800-900 (display); Instrument Serif italic for 1-2 accent words only |
| **Code / labels** | JetBrains Mono (lean into the "engineer" identity) |
| **Logo** | Use `social/` lockups for posts; `lockup-paper.svg` on dark, `lockup-indigo.svg` on cream |

**Tone:** confident, technical, no fluff. Talk like engineers, not marketers. Show code and deployed UIs, not stock photos.
...
## 10. Asset Checklist (to produce before launch)
...
- [ ] Objection-handler carousel set (3)
- [ ] Sold-out + Cohort 2 waitlist graphic
