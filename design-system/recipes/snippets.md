...
> Surfaces: blocks are written for the **dark** theme. For **paper** theme, swap bg `#0A0B10→#F5F2EA`,
> card `#11131C→#FFF`, text `#F5F2EA→#0A0B10`, body `#C9C5BA→#3A3D47`, hairline
...
:root{
  ...
  --paper:#F5F2EA; --paper-dim:#C9C5BA; --ink:#0A0B10; --ink-2:#11131C; --ink-3:#181B28;
  --muted:#7A7F90; --warn:#FF6E5A; --success:#4ADE80;
...
<style>
  ...
  .btn-primary{background:#5B5BF0;color:#F5F2EA}
  .btn-primary:hover{transform:translateY(-2px);background:#6E78F5;box-shadow:0 8px 32px -8px rgba(91,91,240,.35)}
  .btn-ghost{background:transparent;color:#F5F2EA;border:1px solid rgba(245,242,234,0.16)}
  .btn-ghost:hover{transform:translateY(-2px);border-color:#8B97FF}
</style>
...
<div style="background:#11131C;border:1px solid rgba(245,242,234,0.08);border-radius:18px;padding:28px">
  ...
  <h3 style="font-family:'Manrope';font-weight:800;font-size:28px;letter-spacing:-0.025em;color:#F5F2EA;margin-top:10px">a chatbot that answers from your docs</h3>
</div>

<!-- stat card -->
<div style="background:#11131C;border:1px solid rgba(245,242,234,0.08);border-radius:18px;padding:24px 28px">
  <div style="font-family:'Manrope';font-weight:900;font-size:48px;letter-spacing:-0.04em;color:#F5F2EA">20</div>
  <div style="font-family:'JetBrains Mono';font-size:11px;letter-spacing:0.18em;text-transform:uppercase;color:#7A7F90;margin-top:4px">SEATS · CAPPED</div>
</div>
```
...
<div style="background:#11131C;border:1px solid rgba(245,242,234,0.08);border-radius:16px;padding:22px;display:flex;gap:16px;align-items:flex-start">
  ...
  <div style="width:44px;height:44px;border-radius:3px;background:#5B5BF0;display:flex;align-items:center;justify-content:center;flex-shrink:0">
    <span style="font-family:'Instrument Serif';font-style:italic;font-size:24px;color:#F5F2EA">B</span>
  </div>
  <div>
    <span style="font-family:'JetBrains Mono';font-size:10px;letter-spacing:0.18em;text-transform:uppercase;color:#7A7F90">LESSON 047 · 60 SECONDS</span>
    <h4 style="font-family:'Manrope';font-weight:800;font-size:18px;letter-spacing:-0.02em;color:#F5F2EA;text-transform:lowercase;margin-top:6px">how mitosis <em style="font-family:'Instrument Serif';font-style:italic;font-weight:400;color:#8B97FF">splits</em> a cell</h4>
  </div>
</div>
```
...
<span style="font-family:'JetBrains Mono';font-size:11px;letter-spacing:0.12em;text-transform:uppercase;padding:6px 12px;border-radius:999px;background:rgba(255,110,90,0.12);color:#FF6E5A">7 of 20 seats left</span>
```
...
.hero-indigo{background:radial-gradient(140% 100% at 0% 0%,#5B5BF0 0%,#3A2BB8 36%,#0B0822 100%)}
...
<div style="position:relative;width:1920px;height:1080px;overflow:hidden;background:#0A0B10;padding:120px">
</div>

<!-- A4 page (print) -->
<style>@page{size:A4;margin:0}</style>
<div style="position:relative;width:794px;min-height:1123px;background:#F5F2EA;color:#0A0B10;padding:72px">
...
<div style="position:relative;display:flex;align-items:center;justify-content:center">
  ...
  <svg class="focal" viewBox="0 0 180 180" width="460" height="460"><path d="M13 13 L167 13 L167 82 L120 112.5 L167 143 L167 167 L13 167 Z" fill="#F5F2EA"/></svg>
</div>
```
...
.cine-paper {background:radial-gradient(120% 150% at 24% 12%,#EFEAFE,#F2EEE5 44%,#ECE7DA 100%)}
...
<div style="border-radius:14px;overflow:hidden;background:#11131C;border:1px solid rgba(245,242,234,0.10);box-shadow:0 30px 80px -30px rgba(0,0,0,0.7),0 8px 32px -8px rgba(91,91,240,0.35)">
  <div style="display:flex;align-items:center;gap:8px;padding:13px 16px;background:#181B28;border-bottom:1px solid rgba(245,242,234,0.08)">
    ...
    <span style="margin-left:14px;font-family:'JetBrains Mono';font-size:11px;color:#7A7F90">localhost:3000 — saas-dashboard</span>
  </div>
  <div style="padding:26px 24px;display:flex;flex-direction:column;gap:18px">
    <div style="display:flex;justify-content:space-between;align-items:baseline">
      <span style="font-family:'Manrope';font-weight:800;font-size:22px;letter-spacing:-0.02em;color:#F5F2EA">revenue</span>
      <span style="font-family:'JetBrains Mono';font-size:12px;color:#8B97FF">+18.4% ↑</span>
    </div>
    <div style="height:130px;display:flex;align-items:flex-end;gap:12px">
      <!-- bars: indigo gradient, varying heights -->
      <span style="flex:1;height:46%;background:linear-gradient(180deg,#8B97FF,#5B5BF0);border-radius:5px 5px 0 0"></span>
      <span style="flex:1;height:64%;background:linear-gradient(180deg,#8B97FF,#5B5BF0);border-radius:5px 5px 0 0"></span>
      <span style="flex:1;height:38%;background:linear-gradient(180deg,#8B97FF,#5B5BF0);border-radius:5px 5px 0 0"></span>
      <span style="flex:1;height:82%;background:linear-gradient(180deg,#8B97FF,#5B5BF0);border-radius:5px 5px 0 0"></span>
      <span style="flex:1;height:70%;background:linear-gradient(180deg,#8B97FF,#5B5BF0);border-radius:5px 5px 0 0"></span>
      <span style="flex:1;height:100%;background:linear-gradient(180deg,#F5F2EA,#8B97FF);border-radius:5px 5px 0 0"></span>
    </div>
    <div style="display:flex;gap:12px">
      <div style="flex:1;background:rgba(245,242,234,0.04);border:1px solid rgba(245,242,234,0.08);border-radius:12px;padding:14px 16px">
        <div style="font-family:'Manrope';font-weight:900;font-size:26px;color:#F5F2EA">2,481</div>
        <div style="font-family:'JetBrains Mono';font-size:10px;letter-spacing:0.16em;text-transform:uppercase;color:#7A7F90;margin-top:2px">users</div>
      </div>
      <div style="flex:1;background:rgba(245,242,234,0.04);border:1px solid rgba(245,242,234,0.08);border-radius:12px;padding:14px 16px">
        <div style="font-family:'Manrope';font-weight:900;font-size:26px;color:#F5F2EA">99.9%</div>
        <div style="font-family:'JetBrains Mono';font-size:10px;letter-spacing:0.16em;text-transform:uppercase;color:#7A7F90;margin-top:2px">uptime</div>
      </div>
    </div>
  </div>
</div>
...
<div style="padding:22px;display:flex;flex-direction:column;gap:12px">
  <div style="align-self:flex-end;max-width:78%;background:#5B5BF0;color:#F5F2EA;border-radius:14px 14px 4px 14px;padding:12px 16px;font-family:'Manrope';font-size:15px">summarise our refund policy</div>
  <div style="align-self:flex-start;max-width:86%;background:rgba(245,242,234,0.05);border:1px solid rgba(245,242,234,0.08);color:#C9C5BA;border-radius:14px 14px 14px 4px;padding:12px 16px;font-family:'Manrope';font-size:15px">Refunds are issued within 14 days… <span style="color:#8B97FF;font-family:'JetBrains Mono';font-size:11px">[policy.pdf · p.3]</span></div>
</div> -->
```
...
<span style="display:inline-flex;align-items:center;gap:10px;font-family:'Manrope';font-weight:900;font-size:18px;letter-spacing:0.04em;text-transform:uppercase;color:#0A0B10;background:#8B97FF;border-radius:9px;padding:10px 18px;box-shadow:0 10px 34px -10px rgba(91,91,240,0.55)">
  <svg viewBox="0 0 180 180" width="18" height="18"><path d="M13 13 L167 13 L167 82 L120 112.5 L167 143 L167 167 L13 167 Z" fill="#0A0B10"/></svg> deployed
</span>
...
<figure style="display:flex;gap:18px;align-items:center;margin-top:26px">
  <div style="width:72px;height:72px;border-radius:50%;background:#11131C;border:1px solid rgba(245,242,234,0.12);flex-shrink:0;display:flex;align-items:center;justify-content:center;overflow:hidden">
    ...
    <svg viewBox="0 0 180 180" width="30" height="30"><path d="M13 13 L167 13 L167 82 L120 112.5 L167 143 L167 167 L13 167 Z" fill="#8B97FF"/></svg>
  </div>
  <figcaption>
...
<div style="display:flex;gap:16px;align-items:flex-start">
  <span style="width:46px;height:46px;border-radius:12px;background:rgba(139,151,255,0.12);border:1px solid rgba(139,151,255,0.22);display:flex;align-items:center;justify-content:center;flex-shrink:0">
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#8B97FF" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>
  </span>
  <div>
    <p style="font-family:'Manrope';font-weight:800;font-size:18px;letter-spacing:-0.01em;color:#F5F2EA">ship 3 deployed projects</p>
    <p style="font-family:'Manrope';font-weight:500;font-size:14px;line-height:1.5;color:#C9C5BA;margin-top:3px">a SaaS dashboard, a RAG chatbot, an agentic platform.</p>
  </div>
</div>
...
<div style="position:relative;display:flex;align-items:center;justify-content:center;width:760px;height:760px">
  ...
  <svg viewBox="0 0 180 180" width="300" height="300" style="position:relative;z-index:1"><path d="M13 13 L167 13 L167 82 L120 112.5 L167 143 L167 167 L13 167 Z" fill="#F5F2EA"/></svg>
</div>
```
...
<div style="background:rgba(20,18,52,0.55);backdrop-filter:blur(10px);border:1px solid rgba(245,242,234,0.14);border-radius:22px;padding:26px 24px;box-shadow:0 20px 50px -18px rgba(0,0,0,0.6)">
  ...
  <div style="display:flex;flex-direction:column;gap:12px">
    <div style="font-family:'Manrope';font-weight:700;font-size:21px;color:#F5F2EA;background:rgba(245,242,234,0.06);border:1px solid rgba(245,242,234,0.16);border-radius:14px;padding:16px 22px">not yet</div>
    <div style="font-family:'Manrope';font-weight:700;font-size:21px;color:#F5F2EA;background:rgba(245,242,234,0.06);border:1px solid rgba(245,242,234,0.16);border-radius:14px;padding:16px 22px">i'm getting there</div>
  </div>
</div>
```
