...
as proof. lowercase display headlines; mono UPPERCASE labels; NO emoji; exactly one _serif accent
word_ per hook (signalled with _asterisks_). No hype words (level up, unlock, supercharge,
